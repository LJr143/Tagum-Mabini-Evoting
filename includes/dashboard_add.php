...
$conn = new mysqli(DB_HOST,DB_USER,DB_PASS,DB_NAME);
$query  = "select * FROM tbvoters where campus = 'Tagum' ";
...
$conn = new mysqli(DB_HOST,DB_USER,DB_PASS,DB_NAME);
$query  = "select * FROM tbvoters where campus = 'Mabini' ";
...
$queryTagumBar1 = "SELECT campus, COUNT(*) as 'tt_voter_tagum' FROM tbvoters WHERE campus = 'Tagum' GROUP BY campus";
...
$queryMabiniBar1 = "SELECT campus, COUNT(*) as 'tt_voter_mabini' FROM tbvoters WHERE campus = 'Mabini' GROUP BY campus";
