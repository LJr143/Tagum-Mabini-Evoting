<?php
    ...
    $query = "INSERT into tbvoters (fname,lname,campus, college,program,year,stud_id,password,email) VALUES('$fname','$lname','$campus','$college','$program','$year','$sutdID','$pass','$email')";
