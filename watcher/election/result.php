...
<html lang="en">  
  <head>
    ...
    <title>USeP E-Voting | Watcher | Election Result</title>
    ...
    <style>
        #nominees2_filterSelect1,#nominees_filterSelect2, #nominees2_filterSelect2,#nominees2_filterSelect3,#nominees2_filterSelect4{
    ...
    <div id="wrapper">
      ...
      <li class="text-center">
        ...
        <li class="nav-item active bg-danger">
          <a class="nav-link" href="../election/result.php">
