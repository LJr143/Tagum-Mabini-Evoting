                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-oarty-tab" data-toggle="tab" href="#nav-party" role="tab" aria-controls="nav-party" aria-selected="true">Political Party</a>
                                <a class="nav-item nav-link" id="nav-position-tab" data-toggle="tab" href="#nav-position" role="tab" aria-controls="nav-position" aria-selected="false">Local Council Positions</a>
                                <a class="nav-item nav-link" id="nav-council-tab" data-toggle="tab" href="#nav-council" role="tab" aria-controls="nav-council" aria-selected="false">Student Council Positions</a>

                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-party" role="tabpanel" aria-labelledby="nav-party-tab">
                          ...
                          <tr>
                            ...
                            <div class="tab-pane fade" id="nav-council" role="tabpanel" aria-labelledby="nav-council-tab">
